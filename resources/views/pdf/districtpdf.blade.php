                                    ...
                                    @if($districtParticipation->grade==$tqfeedback2->grade)
                                      @if($tqfeedback2->level=='tq')
                                        ...
                                        @endphp
                                          <div class="col-md-6">
                                            <div
                                              class="octagon-card {{isset($octoganCardbgColor[$tq3])?$octoganCardbgColor[$tq3]:''}} {{isset($octoganCardbgColor[$tq3])&& $octoganCardbgColor[$tq3]!='o-color-white'?'text-white':''}} text-center"
                                            >
