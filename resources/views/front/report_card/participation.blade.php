                                  ...
                                  <!-- <div class="tab-pane fade" id="participation" role="tabpanel" aria-labelledby="participation-tab">
                                    <div class="totalpart-card-wrap">
                                      <div class="row">
                                        <div class="col-md-12">
                                            <h2 class="heading-grey text-center">
                                              TOTAL PARTICIPATION OF CLASS <span id="current_class">
                                            </h2>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="card-content card-green">
                                                ...
                                                <div class="card-desc">
                                                    <span class="total-no count" id="participation_school">59</span>
                                                    <p class="title">Schools</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                          <div class="card-content card-pink">
                                            ...
                                            <div class="card-desc">
                                                <span class="total-no count" id="participation_students">183</span>
                                                <p class="title">Teachers</p>
                                            </div>
                                          </div>
                                        </div>
