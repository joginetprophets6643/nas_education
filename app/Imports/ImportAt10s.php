    ...
    */
    public function model(array $row)
    {
        ...
        else
        {
            ...
            $data['at1_cwd_error_desc']     =        "at1_cwd should be 1,2,3,4,5,6,X";
