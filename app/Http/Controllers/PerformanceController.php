...
class PerformanceController extends Controller
{
    ...
    public function queryFunctionPerformanceLevel($querySyntax,$queryGroupSyntax,$queryGroupCondition)
    {
        ...
        round((count(CASE WHEN (l_avg::float)<=35 THEN l_avg END)::decimal*100)/count(l_avg::float),2) AS l_avg_below_basic,
        ...
        round((count(CASE WHEN (m_avg::float)<=35 THEN m_avg END)::decimal*100)/count(m_avg::float),2) AS m_avg_below_basic,
        ...
        round((count(CASE WHEN (e_avg::float)<=35 THEN e_avg END)::decimal*100)/count(e_avg::float),2) AS e_avg_below_basic,
        ...
        round((count(CASE WHEN (mil_avg::float)<=35 THEN mil_avg END)::decimal*100)/count(mil_avg::float),2) AS mil_avg_below_basic,
        ...
        round((count(CASE WHEN (eng_avg::float)<=35 THEN eng_avg END)::decimal*100)/count(eng_avg::float),2) AS eng_avg_below_basic,
        ...
        round((count(CASE WHEN (sci_avg::float)<=35 THEN sci_avg END)::decimal*100)/count(sci_avg::float),2) AS sci_avg_below_basic,
        ...
        round((count(CASE WHEN (sst_avg::float)<=35 THEN sst_avg END)::decimal*100)/count(sst_avg::float),2) AS sst_avg_below_basic,
