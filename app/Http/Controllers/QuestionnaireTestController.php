...
class QuestionnaireTestController extends Controller
{
    public function questionnaireCalculation()
    {
        ...
        if($district==1)
        {
            $querySyntax = 'state_id,district_id,grade,';
            $queryGroupSyntax = 'at3_performance_data.state_id, at3_performance_data.district_id, at3_performance_data.grade';
            $queryGroupCondition = '';
        ...
        if(count($at3Data)>0)
        {
            ...
            {
                $newData3Grade = $this->dataCalculate($stateLevel,$nasDetails3,$grade=1);
    ...
    public function queryFunction($querySyntax,$queryGroupSyntax,$queryGroupCondition)
    {
        ...
        ".$queryGroupCondition."
        group by ".$queryGroupSyntax;

        return $query;

    }

    public function dataCalculate($stateLevel,$nasDetails3,$grade)
    {
                        
        if($stateLevel==1 && $grade==1)
        {
            $querySyntax = 'state_id,grade,';
            $queryGroupSyntax = 'at3_performance_data.state_id, at3_performance_data.grade';
