...
class VisualizationCalculationController extends Controller
{
    public function visualization_participation()
    {
        ...
        $national_data = DB::table(
            'all_grade_national_participation_tbl'
        )->get();
    ...
    public function visualization_performance()
    {
        ...
        foreach ($state_data as $state) {
            ...
            foreach ($formatted_data as $key => $data) {
                ...
                DB::table('visualization_performance_tbl')
                    ->where('state_id', $state->state_id)
                    ->where('grade', $state->grade)
                    ->update([
    ...
    public function queryFunctionVisualizationGraph(
        $querySyntax,
        $queryGroupSyntax,
        $queryGroupCondition
    ) {
    ...
    public function queryFunctionPerformanceLevel(
        $querySyntax,
        $queryGroupSyntax,
        $queryGroupCondition
    ) {
        $query =
            'select ' .
            $querySyntax .
            "  grade, count(CASE WHEN round(m_avg::float)<=35 THEN m_avg END) as b,count(m_avg::float),
    ...
    {
        $performanceDistrictLevelGraph = [];
        // District Level Change Syntax
        $querySyntax = 'state_id,district_id,';
        $queryGroupSyntax =
            'at3_performance_data.state_id, at3_performance_data.district_id,';
        $queryGroupCondition = '';
        $query = $this->queryFunctionVisualizationGraph(
            $querySyntax,
            $queryGroupSyntax,
            $queryGroupCondition
        );
        ...
        if (count($performanceDistrictGraph) > 0) {
            foreach ($performanceDistrictGraph as $performanceDistrictGraph) {
                ...
                $queryGroupSyntax =
                    'at3_performance_data.state_id, at3_performance_data.district_id,';
                $queryGroupCondition =
                    'where  at3_performance_data.state_id=' .
                    (int) $performanceDistrictGraph->state_id .
                    ' and grade = ' .
                    (int) $performanceDistrictGraph->grade .
                    ' and at3_performance_data.district_id = ' .
                    (int) $performanceDistrictGraph->district_id;
                $queryPerformanceLevel = $this->queryFunctionPerformanceLevel(
                    $querySyntax,
                    $queryGroupSyntax,
                    $queryGroupCondition
                );
                ...
                $newArray['language'] = [
                    'gender' => [
                        'district' => [
                            'boys' => isset(
                                $performanceDistrictGraph->l_male_gender
                            )
                                ? $performanceDistrictGraph->l_male_gender
                                : '0',
                            'girls' => isset(
                                $performanceDistrictGraph->l_female_gender
                            )
                                ? $performanceDistrictGraph->l_female_gender
                                : '0',
                        ],
                    ...
                    'location' => [
                        'district' => [
                            'urban' => isset(
                                $performanceDistrictGraph->l_urban_location
                            )
                                ? $performanceDistrictGraph->l_urban_location
                                : '0',
                            'rural' => isset(
                                $performanceDistrictGraph->l_rural_location
                            )
                                ? $performanceDistrictGraph->l_rural_location
                                : '0',
                        ],
                    ...
                    'management' => [
                        'district' => [
                            'govt' => isset(
                                $performanceDistrictGraph->l_govt_management
                            )
                                ? $performanceDistrictGraph->l_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $performanceDistrictGraph->l_govt_aided_management
                            )
                                ? $performanceDistrictGraph->l_govt_aided_management
                                : '0',
                            'private' => isset(
                                $performanceDistrictGraph->l_private_management
                            )
                                ? $performanceDistrictGraph->l_private_management
                                : '0',
                            'central_govt' => isset(
                                $performanceDistrictGraph->l_central_govt_management
                            )
                                ? $performanceDistrictGraph->l_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'district' => [
                            'sc' => isset(
                                $performanceDistrictGraph->l_sc_social_group
                            )
                                ? $performanceDistrictGraph->l_sc_social_group
                                : '0',
                            'obc' => isset(
                                $performanceDistrictGraph->l_obc_social_group
                            )
                                ? $performanceDistrictGraph->l_obc_social_group
                                : '0',
                            'st' => isset(
                                ...
                                : '0',
                            'general' => isset(
                                $performanceDistrictGraph->l_general_social_group
                            )
                                ? $performanceDistrictGraph->l_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'district' => [
                            'below_basic' => isset(
                                $districtPerformanceLevel[0]->m_avg_below_basic
                            )
                                ? $districtPerformanceLevel[0]
                                    ->m_avg_below_basic
                                : '0',
                            'basic' => isset(
                                $districtPerformanceLevel[0]->m_avg_basic
                            )
                                ? $districtPerformanceLevel[0]->m_avg_basic
                                : '0',
                            'proficient' => isset(
                                $districtPerformanceLevel[0]->m_avg_proficient
                            )
                                ? $districtPerformanceLevel[0]->m_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $districtPerformanceLevel[0]->m_avg_advanced
                            )
                                ? $districtPerformanceLevel[0]->m_avg_advanced
                                : '0',
                        ],
                    ...
                    'learning_outcome' => $this->districtLevelLearningOutcome(
                        (int) $performanceDistrictGraph->district_id,
                        (int) $performanceDistrictGraph->grade,
                        'L'
                    ),
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $performanceDistrictGraph->l_male_gender +
                            (int) $performanceDistrictGraph->l_female_gender,
                        'boys' => isset(
                            $performanceDistrictGraph->l_male_gender
                        )
                            ? $performanceDistrictGraph->l_male_gender
                ...
                $newArray['math'] = [
                    'gender' => [
                        'district' => [
                            'boys' => isset(
                                $performanceDistrictGraph->m_male_gender
                            )
                                ? $performanceDistrictGraph->m_male_gender
                                : '0',
                            'girls' => isset(
                                $performanceDistrictGraph->m_female_gender
                            )
                                ? $performanceDistrictGraph->m_female_gender
                                : '0',
                        ],
                    ...
                    'location' => [
                        'district' => [
                            'urban' => isset(
                                $performanceDistrictGraph->m_urban_location
                            )
                                ? $performanceDistrictGraph->m_urban_location
                                : '0',
                            'rural' => isset(
                                $performanceDistrictGraph->m_rural_location
                            )
                                ? $performanceDistrictGraph->m_rural_location
                                : '0',
                        ],
                    ...
                    'management' => [
                        'district' => [
                            'govt' => isset(
                                $performanceDistrictGraph->m_govt_management
                            )
                                ? $performanceDistrictGraph->m_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $performanceDistrictGraph->m_govt_aided_management
                            )
                                ? $performanceDistrictGraph->m_govt_aided_management
                                : '0',
                            'private' => isset(
                                $performanceDistrictGraph->m_private_management
                            )
                                ? $performanceDistrictGraph->m_private_management
                                : '0',
                            'central_govt' => isset(
                                $performanceDistrictGraph->m_central_govt_management
                            )
                                ? $performanceDistrictGraph->m_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'district' => [
                            'sc' => isset(
                                $performanceDistrictGraph->m_sc_social_group
                            )
                                ? $performanceDistrictGraph->m_sc_social_group
                                : '0',
                            'obc' => isset(
                                $performanceDistrictGraph->m_obc_social_group
                            )
                                ? $performanceDistrictGraph->m_obc_social_group
                                : '0',
                            'st' => isset(
                                $performanceDistrictGraph->m_st_social_group
                            )
                                ? $performanceDistrictGraph->m_st_social_group
                                : '0',
                            'general' => isset(
                ...
                $newArray['evs'] = [
                    'gender' => [
                        'district' => [
                            'boys' => isset(
                                ...
                                : '0',
                            'girls' => isset(
                                $performanceDistrictGraph->e_female_gender
                            )
                                ? $performanceDistrictGraph->e_female_gender
                                : '0',
                        ],
                    ...
                    'location' => [
                        'district' => [
                            'urban' => isset(
                                $performanceDistrictGraph->e_urban_location
                            )
                                ? $performanceDistrictGraph->e_urban_location
                                : '0',
                            'rural' => isset(
                                $performanceDistrictGraph->e_rural_location
                            )
                                ? $performanceDistrictGraph->e_rural_location
                                : '0',
                        ],
                    ...
                    'management' => [
                        'district' => [
                            'govt' => isset(
                                $performanceDistrictGraph->e_govt_management
                            )
                                ? $performanceDistrictGraph->e_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $performanceDistrictGraph->e_govt_aided_management
                            )
                                ? $performanceDistrictGraph->e_govt_aided_management
                                : '0',
                            'private' => isset(
                                $performanceDistrictGraph->e_private_management
                            )
                                ? $performanceDistrictGraph->e_private_management
                                : '0',
                            'central_govt' => isset(
                                $performanceDistrictGraph->e_central_govt_management
                            )
                                ? $performanceDistrictGraph->e_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'district' => [
                            'sc' => isset(
                                $performanceDistrictGraph->e_sc_social_group
                            )
                                ? $performanceDistrictGraph->e_sc_social_group
                                : '0',
                            'obc' => isset(
                                $performanceDistrictGraph->e_obc_social_group
                            )
                                ? $performanceDistrictGraph->e_obc_social_group
                                : '0',
                            'st' => isset(
                                $performanceDistrictGraph->e_st_social_group
                            )
                                ? $performanceDistrictGraph->e_st_social_group
                                : '0',
                            'general' => isset(
                                $performanceDistrictGraph->e_general_social_group
                            )
                                ? $performanceDistrictGraph->e_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'district' => [
                            'below_basic' => isset(
                                $districtPerformanceLevel[0]->e_avg_below_basic
                            )
                                ? $districtPerformanceLevel[0]
                                    ->e_avg_below_basic
                                : '0',
                            'basic' => isset(
                                $districtPerformanceLevel[0]->e_avg_basic
                            )
                                ? $districtPerformanceLevel[0]->e_avg_basic
                                : '0',
                            'proficient' => isset(
                                $districtPerformanceLevel[0]->e_avg_proficient
                            )
                                ? $districtPerformanceLevel[0]->e_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $districtPerformanceLevel[0]->e_avg_advanced
                            )
                                ? $districtPerformanceLevel[0]->e_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $performanceDistrictGraph->e_male_gender +
                            (int) $performanceDistrictGraph->e_female_gender,
                        'boys' => isset(
                            $performanceDistrictGraph->e_male_gender
                        )
                            ? $performanceDistrictGraph->e_male_gender
                ...
                $newArray['mil'] = [
                    'gender' => [
                        'district' => [
                            'boys' => isset(
                                $performanceDistrictGraph->mil_male_gender
                            )
                                ? $performanceDistrictGraph->mil_male_gender
                                : '0',
                            'girls' => isset(
                                $performanceDistrictGraph->mil_female_gender
                            )
                                ? $performanceDistrictGraph->mil_female_gender
                                : '0',
                        ],
                    ...
                    'location' => [
                        'district' => [
                            'urban' => isset(
                                $performanceDistrictGraph->mil_urban_location
                            )
                                ? $performanceDistrictGraph->mil_urban_location
                                : '0',
                            'rural' => isset(
                                $performanceDistrictGraph->mil_rural_location
                            )
                                ? $performanceDistrictGraph->mil_rural_location
                                : '0',
                        ],
                    ...
                    'management' => [
                        'district' => [
                            'govt' => isset(
                                $performanceDistrictGraph->mil_govt_management
                            )
                                ? $performanceDistrictGraph->mil_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $performanceDistrictGraph->mil_govt_aided_management
                            )
                                ? $performanceDistrictGraph->mil_govt_aided_management
                                : '0',
                            'private' => isset(
                                $performanceDistrictGraph->mil_private_management
                            )
                                ? $performanceDistrictGraph->mil_private_management
                                : '0',
                            'central_govt' => isset(
                                $performanceDistrictGraph->mil_central_govt_management
                            )
                                ? $performanceDistrictGraph->mil_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'district' => [
                            ...
                            'obc' => isset(
                                ...
                                : '0',
                            'st' => isset(
                                $performanceDistrictGraph->mil_st_social_group
                            )
                                ? $performanceDistrictGraph->mil_st_social_group
                                : '0',
                            'general' => isset(
                                $performanceDistrictGraph->mil_general_social_group
                            )
                                ? $performanceDistrictGraph->mil_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'district' => [
                            'below_basic' => isset(
                                ...
                                : '0',
                            'basic' => isset(
                                $districtPerformanceLevel[0]->mil_avg_basic
                            )
                                ? $districtPerformanceLevel[0]->mil_avg_basic
                                : '0',
                            'proficient' => isset(
                                ...
                                : '0',
                            'advanced' => isset(
                                $districtPerformanceLevel[0]->mil_avg_advanced
                            )
                                ? $districtPerformanceLevel[0]->mil_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $performanceDistrictGraph->mil_male_gender +
                            (int) $performanceDistrictGraph->mil_female_gender,
                        'boys' => isset(
                            $performanceDistrictGraph->mil_male_gender
                        )
                            ? $performanceDistrictGraph->mil_male_gender
                ...
                $newArray['eng'] = [
                    'gender' => [
                        'district' => [
                            'boys' => isset(
                                ...
                                : '0',
                            'girls' => isset(
                                $performanceDistrictGraph->eng_female_gender
                            )
                                ? $performanceDistrictGraph->eng_female_gender
                                : '0',
                        ],
                    ...
                    'location' => [
                        'district' => [
                            'urban' => isset(
                                $performanceDistrictGraph->eng_urban_location
                            )
                                ? $performanceDistrictGraph->eng_urban_location
                                : '0',
                            'rural' => isset(
                                $performanceDistrictGraph->eng_rural_location
                            )
                                ? $performanceDistrictGraph->eng_rural_location
                                : '0',
                        ],
                    ...
                    'management' => [
                        'district' => [
                            'govt' => isset(
                                $performanceDistrictGraph->eng_govt_management
                            )
                                ? $performanceDistrictGraph->eng_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $performanceDistrictGraph->eng_govt_aided_management
                            )
                                ? $performanceDistrictGraph->eng_govt_aided_management
                                : '0',
                            'private' => isset(
                                $performanceDistrictGraph->eng_private_management
                            )
                                ? $performanceDistrictGraph->eng_private_management
                                : '0',
                            'central_govt' => isset(
                                $performanceDistrictGraph->eng_central_govt_management
                            )
                                ? $performanceDistrictGraph->eng_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'district' => [
                            'sc' => isset(
                                $performanceDistrictGraph->eng_sc_social_group
                            )
                                ? $performanceDistrictGraph->eng_sc_social_group
                                : '0',
                            'obc' => isset(
                            ...
                            'st' => isset(
                                ...
                                : '0',
                            'general' => isset(
                                $performanceDistrictGraph->eng_general_social_group
                            )
                                ? $performanceDistrictGraph->eng_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'district' => [
                            ...
                            'basic' => isset(
                                ...
                                : '0',
                            'proficient' => isset(
                                $districtPerformanceLevel[0]->sci_avg_proficient
                            )
                                ? $districtPerformanceLevel[0]
                                    ->sci_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $districtPerformanceLevel[0]->sci_avg_advanced
                            )
                                ? $districtPerformanceLevel[0]->sci_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $performanceDistrictGraph->eng_male_gender +
                            (int) $performanceDistrictGraph->eng_female_gender,
                        'boys' => isset(
                            $performanceDistrictGraph->eng_male_gender
                        )
                            ? $performanceDistrictGraph->eng_male_gender
                ...
                $newArray['sci'] = [
                    'gender' => [
                        'district' => [
                            'boys' => isset(
                                $performanceDistrictGraph->sci_male_gender
                            )
                                ? $performanceDistrictGraph->sci_male_gender
                                : '0',
                            'girls' => isset(
                                $performanceDistrictGraph->sci_female_gender
                            )
                                ? $performanceDistrictGraph->sci_female_gender
                                : '0',
                        ],
                    ...
                    'location' => [
                        'district' => [
                            'urban' => isset(
                                ...
                                : '0',
                            'rural' => isset(
                                $performanceDistrictGraph->sci_rural_location
                            )
                                ? $performanceDistrictGraph->sci_rural_location
                                : '0',
                        ],
                    ...
                    'management' => [
                        'district' => [
                            'govt' => isset(
                                $performanceDistrictGraph->sci_govt_management
                            )
                                ? $performanceDistrictGraph->sci_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $performanceDistrictGraph->sci_govt_aided_management
                            )
                                ? $performanceDistrictGraph->sci_govt_aided_management
                                : '0',
                            'private' => isset(
                                $performanceDistrictGraph->sci_private_management
                            )
                                ? $performanceDistrictGraph->sci_private_management
                                : '0',
                            'central_govt' => isset(
                                $performanceDistrictGraph->sci_central_govt_management
                            )
                                ? $performanceDistrictGraph->sci_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'district' => [
                            'sc' => isset(
                                $performanceDistrictGraph->sci_sc_social_group
                            )
                                ? $performanceDistrictGraph->sci_sc_social_group
                                : '0',
                            'obc' => isset(
                                $performanceDistrictGraph->sci_obc_social_group
                            )
                                ? $performanceDistrictGraph->sci_obc_social_group
                                : '0',
                            'st' => isset(
                                $performanceDistrictGraph->sci_st_social_group
                            )
                                ? $performanceDistrictGraph->sci_st_social_group
                                : '0',
                            'general' => isset(
                                $performanceDistrictGraph->sci_general_social_group
                            )
                                ? $performanceDistrictGraph->sci_general_social_group
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $performanceDistrictGraph->sci_male_gender +
                            (int) $performanceDistrictGraph->sci_female_gender,
                        'boys' => isset(
                            $performanceDistrictGraph->sci_male_gender
                        )
                            ? $performanceDistrictGraph->sci_male_gender
                ...
                $newArray['sst'] = [
                    'gender' => [
                        'district' => [
                            'boys' => isset(
                                $performanceDistrictGraph->sst_male_gender
                            )
                                ? $performanceDistrictGraph->sst_male_gender
                                : '0',
                            'girls' => isset(
                                $performanceDistrictGraph->sst_female_gender
                            )
                                ? $performanceDistrictGraph->sst_female_gender
                                : '0',
                        ],
                    ...
                    'location' => [
                        'district' => [
                            'urban' => isset(
                                $performanceDistrictGraph->sst_urban_location
                            )
                                ? $performanceDistrictGraph->sst_urban_location
                                : '0',
                            'rural' => isset(
                                $performanceDistrictGraph->sst_rural_location
                            )
                                ? $performanceDistrictGraph->sst_rural_location
                                : '0',
                        ],
                    ...
                    'management' => [
                        'district' => [
                            'govt' => isset(
                                $performanceDistrictGraph->sst_govt_management
                            )
                                ? $performanceDistrictGraph->sst_govt_management
                                : '0',
                            'govt_aided' => isset(
                                ...
                                : '0',
                            'private' => isset(
                                $performanceDistrictGraph->sst_private_management
                            )
                                ? $performanceDistrictGraph->sst_private_management
                                : '0',
                            'central_govt' => isset(
                                $performanceDistrictGraph->sst_central_govt_management
                            )
                                ? $performanceDistrictGraph->sst_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'district' => [
                            'sc' => isset(
                                $performanceDistrictGraph->sst_sc_social_group
                            )
                                ? $performanceDistrictGraph->sst_sc_social_group
                                : '0',
                            'obc' => isset(
                                $performanceDistrictGraph->sst_obc_social_group
                            )
                                ? $performanceDistrictGraph->sst_obc_social_group
                                : '0',
                            'st' => isset(
                                $performanceDistrictGraph->sst_st_social_group
                            )
                                ? $performanceDistrictGraph->sst_st_social_group
                                : '0',
                            'general' => isset(
                                $performanceDistrictGraph->sst_general_social_group
                            )
                                ? $performanceDistrictGraph->sst_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'district' => [
                            'below_basic' => isset(
                                ...
                                : '0',
                            'basic' => isset(
                                $districtPerformanceLevel[0]->sst_avg_basic
                            )
                                ? $districtPerformanceLevel[0]->sst_avg_basic
                                : '0',
                            'proficient' => isset(
                                $districtPerformanceLevel[0]->sst_avg_proficient
                            )
                                ? $districtPerformanceLevel[0]
                                    ->sst_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $districtPerformanceLevel[0]->sst_avg_advanced
                            )
                                ? $districtPerformanceLevel[0]->sst_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $performanceDistrictGraph->sst_male_gender +
                            (int) $performanceDistrictGraph->sst_female_gender,
                        'boys' => isset(
                            $performanceDistrictGraph->sst_male_gender
                        )
                            ? $performanceDistrictGraph->sst_male_gender
                ...
                $performanceDistrictLevelGraph['district_id'] =
                    (int) $performanceDistrictGraph->district_id;
                $performanceDistrictLevelGraph['state_id'] = 0;
                $performanceDistrictLevelGraph['grade'] =
                    (int) $performanceDistrictGraph->grade;
            ...
            $msg = Visualization_Performance_Graph_Tbl::insert(
                $finalArrayOfPerformance
            );
            if ($msg) {
                return true;
            } else {
    ...
    public function getStateLevelPerfomanceGraph()
    {
        ...
        $queryGroupCondition = '';
        $stateQuery = $this->queryFunctionVisualizationGraph(
            $querySyntax,
            $queryGroupSyntax,
            $queryGroupCondition
        );
        ...
        if (count($stateLevelPerfomanceData) > 0) {
            foreach ($stateLevelPerfomanceData as $stateData) {
                ...
                $queryGroupCondition =
                    'where  at3_performance_data.state_id=' .
                    (int) $stateData->state_id .
                    ' and grade = ' .
                    (int) $stateData->grade;
                $statePerformanceQuery = $this->queryFunctionPerformanceLevel(
                    $querySyntax,
                    $queryGroupSyntax,
                    $queryGroupCondition
                );
                ...
                // Calculation Language  for District Level
                $newStateArray['language'] = [
                    'gender' => [
                        'state' => [
                            'boys' => isset($stateData->l_male_gender)
                                ? $stateData->l_male_gender
                                : '0',
                            'girls' => isset($stateData->l_female_gender)
                                ? $stateData->l_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'state' => [
                            'urban' => isset($stateData->l_urban_location)
                                ? $stateData->l_urban_location
                                : '0',
                            'rural' => isset($stateData->l_rural_location)
                    ...
                    'management' => [
                        'state' => [
                            'govt' => isset($stateData->l_govt_management)
                                ? $stateData->l_govt_management
                                : '0',
                            'govt_aided' => isset(
                                ...
                                ? $stateData->l_govt_aided_management
                                : '0',
                            'private' => isset($stateData->l_private_management)
                                ? $stateData->l_private_management
                                : '0',
                            'central_govt' => isset(
                                $stateData->l_central_govt_management
                            )
                                ? $stateData->l_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'state' => [
                            'sc' => isset($stateData->l_sc_social_group)
                                ? $stateData->l_sc_social_group
                                : '0',
                            'obc' => isset($stateData->l_obc_social_group)
                                ? $stateData->l_obc_social_group
                                : '0',
                            'st' => isset($stateData->l_st_social_group)
                                ? $stateData->l_st_social_group
                                : '0',
                            'general' => isset(
                                $stateData->l_general_social_group
                            )
                                ? $stateData->l_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'state' => [
                            'below_basic' => isset(
                                $statePerLevel[0]->m_avg_below_basic
                            )
                                ? $statePerLevel[0]->m_avg_below_basic
                                : '0',
                            'basic' => isset($statePerLevel[0]->m_avg_basic)
                                ? $statePerLevel[0]->m_avg_basic
                                : '0',
                            'proficient' => isset(
                                $statePerLevel[0]->m_avg_proficient
                            )
                                ? $statePerLevel[0]->m_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $statePerLevel[0]->m_avg_advanced
                            )
                                ? $statePerLevel[0]->m_avg_advanced
                                : '0',
                        ],
                    ...
                    'learning_outcome' => $this->stateLevelLearningOutcome(
                        (int) $stateData->state_id,
                        (int) $stateData->grade,
                        'L'
                    ),
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $stateData->l_male_gender +
                            (int) $stateData->l_female_gender,
                        'boys' => isset($stateData->l_male_gender)
                            ? $stateData->l_male_gender
                            : '0',
                        'girls' => isset($stateData->l_female_gender)
                        ...
                        'st' => isset($stateData->l_st_social_group)
                            ? $stateData->l_st_social_group
                            : '0',
                        'general' => isset($stateData->l_general_social_group)
                            ? $stateData->l_general_social_group
                            : '0',
                    ],
                ];
                ...
                $newStateArray['math'] = [
                    'gender' => [
                        'state' => [
                            'boys' => isset($stateData->m_male_gender)
                                ? $stateData->m_male_gender
                                : '0',
                            'girls' => isset($stateData->m_female_gender)
                                ? $stateData->m_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'state' => [
                            'urban' => isset($stateData->m_urban_location)
                                ? $stateData->m_urban_location
                                : '0',
                            'rural' => isset($stateData->m_rural_location)
                                ? $stateData->m_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'state' => [
                            ...
                            'govt_aided' => isset(
                                ...
                                ? $stateData->m_govt_aided_management
                                : '0',
                            'private' => isset($stateData->m_private_management)
                                ? $stateData->m_private_management
                                : '0',
                            'central_govt' => isset(
                                $stateData->m_central_govt_management
                            )
                                ? $stateData->m_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'state' => [
                            'sc' => isset($stateData->m_sc_social_group)
                                ? $stateData->m_sc_social_group
                                : '0',
                            'obc' => isset($stateData->m_obc_social_group)
                                ? $stateData->m_obc_social_group
                                : '0',
                            'st' => isset($stateData->m_st_social_group)
                                ? $stateData->m_st_social_group
                                : '0',
                            'general' => isset(
                                $stateData->m_general_social_group
                            )
                                ? $stateData->m_general_social_group
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $stateData->m_male_gender +
                            (int) $stateData->m_female_gender,
                        'boys' => isset($stateData->m_male_gender)
                            ? $stateData->m_male_gender
                            : '0',
                        'girls' => isset($stateData->m_female_gender)
                        ...
                        'st' => isset($stateData->m_st_social_group)
                            ? $stateData->m_st_social_group
                            : '0',
                        'general' => isset($stateData->m_general_social_group)
                            ? $stateData->m_general_social_group
                            : '0',
                    ],
                ];
                ...
                $newStateArray['evs'] = [
                    'gender' => [
                        'state' => [
                            'boys' => isset($stateData->e_male_gender)
                                ? $stateData->e_male_gender
                                : '0',
                            'girls' => isset($stateData->e_female_gender)
                                ? $stateData->e_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'state' => [
                            'urban' => isset($stateData->e_urban_location)
                                ? $stateData->e_urban_location
                                : '0',
                            'rural' => isset($stateData->e_rural_location)
                                ? $stateData->e_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'state' => [
                            'govt' => isset($stateData->e_govt_management)
                                ? $stateData->e_govt_management
                                : '0',
                            'govt_aided' => isset(
                                ...
                                ? $stateData->e_govt_aided_management
                                : '0',
                            'private' => isset($stateData->e_private_management)
                                ? $stateData->e_private_management
                                : '0',
                            'central_govt' => isset(
                    ...
                    'socialgroup' => [
                        'state' => [
                            'sc' => isset($stateData->e_sc_social_group)
                                ? $stateData->e_sc_social_group
                                : '0',
                            'obc' => isset($stateData->e_obc_social_group)
                                ? $stateData->e_obc_social_group
                                : '0',
                            'st' => isset($stateData->e_st_social_group)
                    ...
                    'performance_level' => [
                        'state' => [
                            'below_basic' => isset(
                                $statePerLevel[0]->e_avg_below_basic
                            )
                                ? $statePerLevel[0]->e_avg_below_basic
                                : '0',
                            'basic' => isset($statePerLevel[0]->e_avg_basic)
                                ? $statePerLevel[0]->e_avg_basic
                                : '0',
                            'proficient' => isset(
                                $statePerLevel[0]->e_avg_proficient
                            )
                                ? $statePerLevel[0]->e_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $statePerLevel[0]->e_avg_advanced
                            )
                                ? $statePerLevel[0]->e_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $stateData->e_male_gender +
                            (int) $stateData->e_female_gender,
                        'boys' => isset($stateData->e_male_gender)
                            ? $stateData->e_male_gender
                            : '0',
                        'girls' => isset($stateData->e_female_gender)
                        ...
                        'st' => isset($stateData->e_st_social_group)
                            ? $stateData->e_st_social_group
                            : '0',
                        'general' => isset($stateData->e_general_social_group)
                            ? $stateData->e_general_social_group
                            : '0',
                    ],
                ];
                ...
                $newStateArray['mil'] = [
                    'gender' => [
                        'state' => [
                            'boys' => isset($stateData->mil_male_gender)
                                ? $stateData->mil_male_gender
                                : '0',
                            'girls' => isset($stateData->mil_female_gender)
                                ? $stateData->mil_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'state' => [
                            'urban' => isset($stateData->mil_urban_location)
                                ? $stateData->mil_urban_location
                                : '0',
                            'rural' => isset($stateData->mil_rural_location)
                                ? $stateData->mil_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'state' => [
                            'govt' => isset($stateData->mil_govt_management)
                                ? $stateData->mil_govt_management
                                : '0',
                            'govt_aided' => isset(
                                ...
                                : '0',
                            'private' => isset(
                                $stateData->mil_private_management
                            )
                                ? $stateData->mil_private_management
                                : '0',
                            'central_govt' => isset(
                                $stateData->mil_central_govt_management
                            )
                                ? $stateData->mil_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'state' => [
                            'sc' => isset($stateData->mil_sc_social_group)
                                ? $stateData->mil_sc_social_group
                                : '0',
                            'obc' => isset($stateData->mil_obc_social_group)
                                ? $stateData->mil_obc_social_group
                                : '0',
                            'st' => isset($stateData->mil_st_social_group)
                                ? $stateData->mil_st_social_group
                                : '0',
                            'general' => isset(
                                $stateData->mil_general_social_group
                            )
                                ? $stateData->mil_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'state' => [
                            'below_basic' => isset(
                                $statePerLevel[0]->mil_avg_below_basic
                            )
                                ? $statePerLevel[0]->mil_avg_below_basic
                                : '0',
                            'basic' => isset($statePerLevel[0]->mil_avg_basic)
                                ? $statePerLevel[0]->mil_avg_basic
                                : '0',
                            'proficient' => isset(
                                ...
                                : '0',
                            'advanced' => isset(
                                $statePerLevel[0]->mil_avg_advanced
                            )
                                ? $statePerLevel[0]->mil_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $stateData->mil_male_gender +
                            (int) $stateData->mil_female_gender,
                        'boys' => isset($stateData->mil_male_gender)
                            ? $stateData->mil_male_gender
                            : '0',
                        'girls' => isset($stateData->mil_female_gender)
                        ...
                        'st' => isset($stateData->mil_st_social_group)
                            ? $stateData->mil_st_social_group
                            : '0',
                        'general' => isset($stateData->mil_general_social_group)
                            ? $stateData->mil_general_social_group
                            : '0',
                    ],
                ];
                ...
                $newStateArray['eng'] = [
                    'gender' => [
                        'state' => [
                            'boys' => isset($stateData->eng_male_gender)
                                ? $stateData->eng_male_gender
                                : '0',
                            'girls' => isset($stateData->eng_female_gender)
                                ? $stateData->eng_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'state' => [
                            'urban' => isset($stateData->eng_urban_location)
                                ? $stateData->eng_urban_location
                                : '0',
                            'rural' => isset($stateData->eng_rural_location)
                                ? $stateData->eng_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'state' => [
                            'govt' => isset($stateData->eng_govt_management)
                                ? $stateData->eng_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $stateData->eng_govt_aided_management
                            )
                                ? $stateData->eng_govt_aided_management
                                : '0',
                            'private' => isset(
                                ...
                                : '0',
                            'central_govt' => isset(
                                $stateData->eng_central_govt_management
                            )
                                ? $stateData->eng_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'state' => [
                            'sc' => isset($stateData->eng_sc_social_group)
                                ? $stateData->eng_sc_social_group
                                : '0',
                            'obc' => isset($stateData->eng_obc_social_group)
                                ? $stateData->eng_obc_social_group
                                : '0',
                            'st' => isset($stateData->eng_st_social_group)
                                ? $stateData->eng_st_social_group
                                : '0',
                            'general' => isset(
                                $stateData->eng_general_social_group
                            )
                                ? $stateData->eng_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'state' => [
                            'below_basic' => isset(
                                $statePerLevel[0]->sci_avg_below_basic
                            )
                                ? $statePerLevel[0]->sci_avg_below_basic
                                : '0',
                            'basic' => isset($statePerLevel[0]->sci_avg_basic)
                                ? $statePerLevel[0]->sci_avg_basic
                                : '0',
                            'proficient' => isset(
                                $statePerLevel[0]->sci_avg_proficient
                            )
                                ? $statePerLevel[0]->sci_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $statePerLevel[0]->sci_avg_advanced
                            )
                                ? $statePerLevel[0]->sci_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $stateData->eng_male_gender +
                            (int) $stateData->eng_female_gender,
                        'boys' => isset($stateData->eng_male_gender)
                            ? $stateData->eng_male_gender
                            : '0',
                        'girls' => isset($stateData->eng_female_gender)
                        ...
                        'st' => isset($stateData->eng_st_social_group)
                            ? $stateData->eng_st_social_group
                            : '0',
                        'general' => isset($stateData->eng_general_social_group)
                            ? $stateData->eng_general_social_group
                            : '0',
                    ],
                ];
                ...
                $newStateArray['sci'] = [
                    'gender' => [
                        'state' => [
                            'boys' => isset($stateData->sci_male_gender)
                                ? $stateData->sci_male_gender
                                : '0',
                            'girls' => isset($stateData->sci_female_gender)
                                ? $stateData->sci_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'state' => [
                            'urban' => isset($stateData->sci_urban_location)
                                ? $stateData->sci_urban_location
                                : '0',
                            'rural' => isset($stateData->sci_rural_location)
                                ? $stateData->sci_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'state' => [
                            'govt' => isset($stateData->sci_govt_management)
                                ? $stateData->sci_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $stateData->sci_govt_aided_management
                            )
                                ? $stateData->sci_govt_aided_management
                                : '0',
                            'private' => isset(
                                $stateData->sci_private_management
                            )
                                ? $stateData->sci_private_management
                                : '0',
                            'central_govt' => isset(
                    ...
                    'socialgroup' => [
                        'state' => [
                            'sc' => isset($stateData->sci_sc_social_group)
                                ? $stateData->sci_sc_social_group
                                : '0',
                            'obc' => isset($stateData->sci_obc_social_group)
                                ? $stateData->sci_obc_social_group
                                : '0',
                            'st' => isset($stateData->sci_st_social_group)
                                ? $stateData->sci_st_social_group
                                : '0',
                            'general' => isset(
                                $stateData->sci_general_social_group
                            )
                                ? $stateData->sci_general_social_group
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $stateData->sci_male_gender +
                            (int) $stateData->sci_female_gender,
                        'boys' => isset($stateData->sci_male_gender)
                            ? $stateData->sci_male_gender
                            : '0',
                        'girls' => isset($stateData->sci_female_gender)
                        ...
                        'st' => isset($stateData->sci_st_social_group)
                            ? $stateData->sci_st_social_group
                            : '0',
                        'general' => isset($stateData->sci_general_social_group)
                            ? $stateData->sci_general_social_group
                            : '0',
                    ],
                ];
                ...
                $newStateArray['sst'] = [
                    'gender' => [
                        'state' => [
                            'boys' => isset($stateData->sst_male_gender)
                                ? $stateData->sst_male_gender
                                : '0',
                            'girls' => isset($stateData->sst_female_gender)
                                ? $stateData->sst_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'state' => [
                            'urban' => isset($stateData->sst_urban_location)
                                ? $stateData->sst_urban_location
                                : '0',
                            'rural' => isset($stateData->sst_rural_location)
                                ? $stateData->sst_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'state' => [
                            'govt' => isset($stateData->sst_govt_management)
                            ...
                            'govt_aided' => isset(
                                ...
                                : '0',
                            'private' => isset(
                                $stateData->sst_private_management
                            )
                                ? $stateData->sst_private_management
                                : '0',
                            'central_govt' => isset(
                                $stateData->sst_central_govt_management
                            )
                                ? $stateData->sst_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'state' => [
                            'sc' => isset($stateData->sst_sc_social_group)
                                ? $stateData->sst_sc_social_group
                                : '0',
                            'obc' => isset($stateData->sst_obc_social_group)
                                ? $stateData->sst_obc_social_group
                                : '0',
                            'st' => isset($stateData->sst_st_social_group)
                                ? $stateData->sst_st_social_group
                                : '0',
                            'general' => isset(
                                $stateData->sst_general_social_group
                            )
                                ? $stateData->sst_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'state' => [
                            'below_basic' => isset(
                                $statePerLevel[0]->sst_avg_below_basic
                            )
                                ? $statePerLevel[0]->sst_avg_below_basic
                                : '0',
                            'basic' => isset($statePerLevel[0]->sst_avg_basic)
                                ? $statePerLevel[0]->sst_avg_basic
                                : '0',
                            'proficient' => isset(
                                $statePerLevel[0]->sst_avg_proficient
                            )
                                ? $statePerLevel[0]->sst_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $statePerLevel[0]->sst_avg_advanced
                            )
                                ? $statePerLevel[0]->sst_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $stateData->sst_male_gender +
                            (int) $stateData->sst_female_gender,
                        'boys' => isset($stateData->sst_male_gender)
                            ? $stateData->sst_male_gender
                            : '0',
                        'girls' => isset($stateData->sst_female_gender)
                        ...
                        'st' => isset($stateData->sst_st_social_group)
                            ? $stateData->sst_st_social_group
                            : '0',
                        'general' => isset($stateData->sst_general_social_group)
                            ? $stateData->sst_general_social_group
                            : '0',
                    ],
                ];
    ...
    public function getNationevelPerfomanceGraph()
    {
        ...
        $queryGroupCondition = '';
        $nationalQuery = $this->queryFunctionVisualizationGraph(
            $querySyntax,
            $queryGroupSyntax,
            $queryGroupCondition
        );
        ...
        if (count($nationLevelPerfomanceData) > 0) {
            foreach ($nationLevelPerfomanceData as $nationalLevel) {
                ...
                $queryGroupSyntax = '';
                $queryGroupCondition =
                    'where grade = ' . (int) $nationalLevel->grade;
                $nationalPerformanceQuery = $this->queryFunctionPerformanceLevel(
                    $querySyntax,
                    $queryGroupSyntax,
                    $queryGroupCondition
                );
                $nationalPerformanceQuery = DB::select(
                    $nationalPerformanceQuery
                );
                // Calculation Language  for District Level
                $newNationalArray['language'] = [
                    'gender' => [
                        'national' => [
                            'boys' => isset($nationalLevel->l_male_gender)
                                ? $nationalLevel->l_male_gender
                                : '0',
                            'girls' => isset($nationalLevel->l_female_gender)
                                ? $nationalLevel->l_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'national' => [
                            'urban' => isset($nationalLevel->l_urban_location)
                                ? $nationalLevel->l_urban_location
                                : '0',
                            'rural' => isset($nationalLevel->l_rural_location)
                                ? $nationalLevel->l_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'national' => [
                            'govt' => isset($nationalLevel->l_govt_management)
                                ? $nationalLevel->l_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $nationalLevel->l_govt_aided_management
                            )
                                ? $nationalLevel->l_govt_aided_management
                                : '0',
                            'private' => isset(
                                ...
                                : '0',
                            'central_govt' => isset(
                                $nationalLevel->l_central_govt_management
                            )
                                ? $nationalLevel->l_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'national' => [
                            'sc' => isset($nationalLevel->l_sc_social_group)
                                ? $nationalLevel->l_sc_social_group
                                : '0',
                            'obc' => isset($nationalLevel->l_obc_social_group)
                                ? $nationalLevel->l_obc_social_group
                                : '0',
                            'st' => isset($nationalLevel->l_st_social_group)
                                ? $nationalLevel->l_st_social_group
                                : '0',
                            'general' => isset(
                                $nationalLevel->l_general_social_group
                            )
                                ? $nationalLevel->l_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'national' => [
                            'below_basic' => isset(
                                $nationalPerformanceQuery[0]->m_avg_below_basic
                            )
                                ? $nationalPerformanceQuery[0]
                                    ->m_avg_below_basic
                                : '0',
                            'basic' => isset(
                                $nationalPerformanceQuery[0]->m_avg_basic
                            )
                                ? $nationalPerformanceQuery[0]->m_avg_basic
                                : '0',
                            'proficient' => isset(
                                $nationalPerformanceQuery[0]->m_avg_proficient
                            )
                                ? $nationalPerformanceQuery[0]->m_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $nationalPerformanceQuery[0]->m_avg_advanced
                            )
                                ? $nationalPerformanceQuery[0]->m_avg_advanced
                                : '0',
                        ],
                    ...
                    'learning_outcome' => $this->nationalLevelLearningOutcome(
                        (int) $nationalLevel->grade,
                        'L'
                    ),
                    'by_indicator' => [
                        'dropdown1' => [
                            'category1' => [
                                'range' => '70-74',
                                'data' => [$this->fetchStatedata(1)],
                            ],
                            'category2' => [
                                'range' => '74-77',
                                'data' => [$this->fetchStatedata(2)],
                            ],
                            'category3' => [
                                'range' => '77-81',
                                'data' => [$this->fetchStatedata(3)],
                            ],
                            'category4' => [
                                'range' => '81-84',
                                'data' => [$this->fetchStatedata(4)],
                            ],
                        ],
                        'dropdown2' => [
                            'category1' => [
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $nationalLevel->l_male_gender +
                            (int) $nationalLevel->l_female_gender,
                        'boys' => isset($nationalLevel->l_male_gender)
                            ? $nationalLevel->l_male_gender
                            : '0',
                        'girls' => isset($nationalLevel->l_female_gender)
                ...
                // Calculation Math  for District Level
                $newNationalArray['math'] = [
                    'gender' => [
                        'national' => [
                            'boys' => isset($nationalLevel->m_male_gender)
                                ? $nationalLevel->m_male_gender
                                : '0',
                            'girls' => isset($nationalLevel->m_female_gender)
                                ? $nationalLevel->m_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'national' => [
                            'urban' => isset($nationalLevel->m_urban_location)
                                ? $nationalLevel->m_urban_location
                                : '0',
                            'rural' => isset($nationalLevel->m_rural_location)
                                ? $nationalLevel->m_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'national' => [
                            'govt' => isset($nationalLevel->m_govt_management)
                                ...
                                : '0',
                            'govt_aided' => isset(
                                $nationalLevel->m_govt_aided_management
                            )
                                ? $nationalLevel->m_govt_aided_management
                                : '0',
                            'private' => isset(
                                ...
                                : '0',
                            'central_govt' => isset(
                                $nationalLevel->m_central_govt_management
                            )
                                ? $nationalLevel->m_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'national' => [
                            'sc' => isset($nationalLevel->m_sc_social_group)
                                ? $nationalLevel->m_sc_social_group
                                : '0',
                            'obc' => isset($nationalLevel->m_obc_social_group)
                                ? $nationalLevel->m_obc_social_group
                                : '0',
                            'st' => isset($nationalLevel->m_st_social_group)
                                ? $nationalLevel->m_st_social_group
                                : '0',
                            'general' => isset(
                                $nationalLevel->m_general_social_group
                            )
                                ? $nationalLevel->m_general_social_group
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $nationalLevel->m_male_gender +
                            (int) $nationalLevel->m_female_gender,
                        'boys' => isset($nationalLevel->m_male_gender)
                            ? $nationalLevel->m_male_gender
                            : '0',
                        'girls' => isset($nationalLevel->m_female_gender)
                ...
                // Calculation EVS  for District Level
                $newNationalArray['evs'] = [
                    'gender' => [
                        'national' => [
                            'boys' => isset($nationalLevel->e_male_gender)
                                ? $nationalLevel->e_male_gender
                                : '0',
                            'girls' => isset($nationalLevel->e_female_gender)
                                ? $nationalLevel->e_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'national' => [
                            'urban' => isset($nationalLevel->e_urban_location)
                                ? $nationalLevel->e_urban_location
                                : '0',
                            'rural' => isset($nationalLevel->e_rural_location)
                                ? $nationalLevel->e_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'national' => [
                            'govt' => isset($nationalLevel->e_govt_management)
                                ? $nationalLevel->e_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $nationalLevel->e_govt_aided_management
                            )
                                ? $nationalLevel->e_govt_aided_management
                                : '0',
                            'private' => isset(
                                ...
                                : '0',
                            'central_govt' => isset(
                                $nationalLevel->e_central_govt_management
                            )
                                ? $nationalLevel->e_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'national' => [
                            'sc' => isset($nationalLevel->e_sc_social_group)
                                ? $nationalLevel->e_sc_social_group
                                : '0',
                            'obc' => isset($nationalLevel->e_obc_social_group)
                                ? $nationalLevel->e_obc_social_group
                                : '0',
                            'st' => isset($nationalLevel->e_st_social_group)
                                ? $nationalLevel->e_st_social_group
                                : '0',
                            'general' => isset(
                                $nationalLevel->e_general_social_group
                            )
                                ? $nationalLevel->e_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'national' => [
                            'below_basic' => isset(
                                $nationalPerformanceQuery[0]->e_avg_below_basic
                            )
                                ? $nationalPerformanceQuery[0]
                                    ->e_avg_below_basic
                                : '0',
                            'basic' => isset(
                                $nationalPerformanceQuery[0]->e_avg_basic
                            )
                                ? $nationalPerformanceQuery[0]->e_avg_basic
                                : '0',
                            'proficient' => isset(
                                $nationalPerformanceQuery[0]->e_avg_proficient
                            )
                                ? $nationalPerformanceQuery[0]->e_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $nationalPerformanceQuery[0]->e_avg_advanced
                            )
                                ? $nationalPerformanceQuery[0]->e_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $nationalLevel->e_male_gender +
                            (int) $nationalLevel->e_female_gender,
                        'boys' => isset($nationalLevel->e_male_gender)
                            ? $nationalLevel->e_male_gender
                            : '0',
                        'girls' => isset($nationalLevel->e_female_gender)
                ...
                // Calculation EVS  for District Level
                $newNationalArray['mil'] = [
                    'gender' => [
                        'national' => [
                            'boys' => isset($nationalLevel->mil_male_gender)
                                ? $nationalLevel->mil_male_gender
                                : '0',
                            'girls' => isset($nationalLevel->mil_female_gender)
                                ? $nationalLevel->mil_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'national' => [
                            'urban' => isset($nationalLevel->mil_urban_location)
                                ? $nationalLevel->mil_urban_location
                                : '0',
                            'rural' => isset($nationalLevel->mil_rural_location)
                                ? $nationalLevel->mil_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'national' => [
                            'govt' => isset($nationalLevel->mil_govt_management)
                                ? $nationalLevel->mil_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $nationalLevel->mil_govt_aided_management
                            )
                                ? $nationalLevel->mil_govt_aided_management
                                : '0',
                            'private' => isset(
                                $nationalLevel->mil_private_management
                            )
                                ? $nationalLevel->mil_private_management
                                : '0',
                            'central_govt' => isset(
                                $nationalLevel->mil_central_govt_management
                            )
                                ? $nationalLevel->mil_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'national' => [
                            'sc' => isset($nationalLevel->mil_sc_social_group)
                                ? $nationalLevel->mil_sc_social_group
                                : '0',
                            'obc' => isset($nationalLevel->mil_obc_social_group)
                                ? $nationalLevel->mil_obc_social_group
                                : '0',
                            'st' => isset($nationalLevel->mil_st_social_group)
                                ? $nationalLevel->mil_st_social_group
                                : '0',
                            'general' => isset(
                    ...
                    'performance_level' => [
                        'national' => [
                            'below_basic' => isset(
                                ...
                                : '0',
                            'basic' => isset(
                                $nationalPerformanceQuery[0]->mil_avg_basic
                            )
                                ? $nationalPerformanceQuery[0]->mil_avg_basic
                                : '0',
                            'proficient' => isset(
                                ...
                                : '0',
                            'advanced' => isset(
                                $nationalPerformanceQuery[0]->mil_avg_advanced
                            )
                                ? $nationalPerformanceQuery[0]->mil_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $nationalLevel->mil_male_gender +
                            (int) $nationalLevel->mil_female_gender,
                        'boys' => isset($nationalLevel->mil_male_gender)
                            ? $nationalLevel->mil_male_gender
                            : '0',
                        'girls' => isset($nationalLevel->mil_female_gender)
                ...
                // Calculation ENGLISH  for District Level
                $newNationalArray['eng'] = [
                    'gender' => [
                        'national' => [
                            'boys' => isset($nationalLevel->eng_male_gender)
                                ? $nationalLevel->eng_male_gender
                                : '0',
                            'girls' => isset($nationalLevel->eng_female_gender)
                                ? $nationalLevel->eng_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'national' => [
                            'urban' => isset($nationalLevel->eng_urban_location)
                                ? $nationalLevel->eng_urban_location
                                : '0',
                            'rural' => isset($nationalLevel->eng_rural_location)
                                ? $nationalLevel->eng_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'national' => [
                            'govt' => isset($nationalLevel->eng_govt_management)
                                ? $nationalLevel->eng_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $nationalLevel->eng_govt_aided_management
                            )
                                ? $nationalLevel->eng_govt_aided_management
                                : '0',
                            'private' => isset(
                                $nationalLevel->eng_private_management
                            )
                                ? $nationalLevel->eng_private_management
                                : '0',
                            'central_govt' => isset(
                                $nationalLevel->eng_central_govt_management
                            )
                                ? $nationalLevel->eng_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'national' => [
                            'sc' => isset($nationalLevel->eng_sc_social_group)
                                ? $nationalLevel->eng_sc_social_group
                                : '0',
                            'obc' => isset($nationalLevel->eng_obc_social_group)
                                ? $nationalLevel->eng_obc_social_group
                                : '0',
                            'st' => isset($nationalLevel->eng_st_social_group)
                                ? $nationalLevel->eng_st_social_group
                                : '0',
                            'general' => isset(
                                $nationalLevel->eng_general_social_group
                            )
                                ? $nationalLevel->eng_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'national' => [
                            ...
                            'basic' => isset(
                                ...
                                : '0',
                            'proficient' => isset(
                                $nationalPerformanceQuery[0]->sci_avg_proficient
                            )
                                ? $nationalPerformanceQuery[0]
                                    ->sci_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $nationalPerformanceQuery[0]->sci_avg_advanced
                            )
                                ? $nationalPerformanceQuery[0]->sci_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $nationalLevel->eng_male_gender +
                            (int) $nationalLevel->eng_female_gender,
                        'boys' => isset($nationalLevel->eng_male_gender)
                            ? $nationalLevel->eng_male_gender
                            : '0',
                        'girls' => isset($nationalLevel->eng_female_gender)
                ...
                // Calculation SCIENCE  for District Level
                $newNationalArray['sci'] = [
                    'gender' => [
                        'national' => [
                            'boys' => isset($nationalLevel->sci_male_gender)
                                ? $nationalLevel->sci_male_gender
                                : '0',
                            'girls' => isset($nationalLevel->sci_female_gender)
                                ? $nationalLevel->sci_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'national' => [
                            'urban' => isset($nationalLevel->sci_urban_location)
                                ? $nationalLevel->sci_urban_location
                                : '0',
                            'rural' => isset($nationalLevel->sci_rural_location)
                                ? $nationalLevel->sci_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'national' => [
                            'govt' => isset($nationalLevel->sci_govt_management)
                                ? $nationalLevel->sci_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $nationalLevel->sci_govt_aided_management
                            )
                                ? $nationalLevel->sci_govt_aided_management
                                : '0',
                            'private' => isset(
                                ...
                                : '0',
                            'central_govt' => isset(
                                $nationalLevel->sci_central_govt_management
                            )
                                ? $nationalLevel->sci_central_govt_management
                                : '0',
                        ],
                    ...
                    'socialgroup' => [
                        'national' => [
                            'sc' => isset($nationalLevel->sci_sc_social_group)
                                ? $nationalLevel->sci_sc_social_group
                                : '0',
                            'obc' => isset($nationalLevel->sci_obc_social_group)
                                ? $nationalLevel->sci_obc_social_group
                                : '0',
                            'st' => isset($nationalLevel->sci_st_social_group)
                                ? $nationalLevel->sci_st_social_group
                                : '0',
                            'general' => isset(
                                $nationalLevel->sci_general_social_group
                            )
                                ? $nationalLevel->sci_general_social_group
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $nationalLevel->sci_male_gender +
                            (int) $nationalLevel->sci_female_gender,
                        'boys' => isset($nationalLevel->sci_male_gender)
                            ? $nationalLevel->sci_male_gender
                            : '0',
                        'girls' => isset($nationalLevel->sci_female_gender)
                ...
                // Calculation SST  for District Level
                $newNationalArray['sst'] = [
                    'gender' => [
                        'national' => [
                            'boys' => isset($nationalLevel->sst_male_gender)
                                ? $nationalLevel->sst_male_gender
                                : '0',
                            'girls' => isset($nationalLevel->sst_female_gender)
                                ? $nationalLevel->sst_female_gender
                                : '0',
                        ],
                    ],
                    'location' => [
                        'national' => [
                            'urban' => isset($nationalLevel->sst_urban_location)
                                ? $nationalLevel->sst_urban_location
                                : '0',
                            'rural' => isset($nationalLevel->sst_rural_location)
                                ? $nationalLevel->sst_rural_location
                                : '0',
                        ],
                    ],
                    'management' => [
                        'national' => [
                            'govt' => isset($nationalLevel->sst_govt_management)
                                ? $nationalLevel->sst_govt_management
                                : '0',
                            'govt_aided' => isset(
                                $nationalLevel->sst_govt_aided_management
                            )
                                ? $nationalLevel->sst_govt_aided_management
                                : '0',
                            'private' => isset(
                                $nationalLevel->sst_private_management
                            )
                                ? $nationalLevel->sst_private_management
                                : '0',
                            'central_govt' => isset(
                    ...
                    'socialgroup' => [
                        'national' => [
                            'sc' => isset($nationalLevel->sst_sc_social_group)
                                ? $nationalLevel->sst_sc_social_group
                                : '0',
                            'obc' => isset($nationalLevel->sst_obc_social_group)
                                ? $nationalLevel->sst_obc_social_group
                                : '0',
                            'st' => isset($nationalLevel->sst_st_social_group)
                                ? $nationalLevel->sst_st_social_group
                                : '0',
                            'general' => isset(
                                $nationalLevel->sst_general_social_group
                            )
                                ? $nationalLevel->sst_general_social_group
                                : '0',
                        ],
                    ...
                    'performance_level' => [
                        'national' => [
                            'below_basic' => isset(
                                ...
                                : '0',
                            'basic' => isset(
                                $nationalPerformanceQuery[0]->sst_avg_basic
                            )
                                ? $nationalPerformanceQuery[0]->sst_avg_basic
                                : '0',
                            'proficient' => isset(
                                $nationalPerformanceQuery[0]->sst_avg_proficient
                            )
                                ? $nationalPerformanceQuery[0]
                                    ->sst_avg_proficient
                                : '0',
                            'advanced' => isset(
                                $nationalPerformanceQuery[0]->sst_avg_advanced
                            )
                                ? $nationalPerformanceQuery[0]->sst_avg_advanced
                                : '0',
                        ],
                    ...
                    'by_subgroup' => [
                        'totals' =>
                            (int) $nationalLevel->sst_male_gender +
                            (int) $nationalLevel->sst_female_gender,
                        'boys' => isset($nationalLevel->sst_male_gender)
                            ? $nationalLevel->sst_male_gender
                            : '0',
                        'girls' => isset($nationalLevel->sst_female_gender)
    ...
    public function fetchStatedata($value)
    {
        switch ($value) {
            case 1:
                $stateIdWithName = DB::table('state_masters')
                    ->pluck('state_id', 'state_name')
                    ->take(9)
                    ->toArray();
                $data = [];
    ...
    {
        $districtIdWithName = DB::table('district_masters')
            ->where('udise_state_code', $state_id)
            ->pluck('udise_district_code', 'district_name')
            ->toArray();
        $data = [];
        ...
        $skip3 =
            (int) round($skip1) + (int) round($skip1) + (int) round($skip1);
    ...
    public function linkedGraphData()
    {
        ...
        $state_data = DB::table('visualization_performance_graph_tbl')
            ->where('type', 'state')
        ...
        $all_subjects = [
            '3' => ['language', 'math', 'evs'],
            '5' => ['language', 'math', 'evs'],
            '8' => ['language', 'math', 'sci', 'sst'],
            '10' => ['mil', 'math', 'sci', 'sst', 'eng'],
        ];
        $final = [
            'total' => 'Total',
            'boys' => 'Boys',
        ...
        foreach ($grades as $grade) {
            ...
            foreach ($subjects as $subject) {
                ...
                foreach ($avs as $legend => $av) {
                    foreach ($av as $value) {
                        $final_state_data[$subject]['avs'][
                            $final[$value]
                        ] = $this->generate_state_av_data(
                            $state_temp_data,
                            $legend,
                            $value,
                            $subject
                ...
                $final_state_data[$subject][
                    'lo'
                ] = $this->generate_state_lo_data($state_temp_data, $subject);
                foreach ($ranges as $range) {
                    $final_state_data[$subject]['range'][
                        $final[$range]
                    ] = $this->generate_state_range_data(
                        $state_temp_data,
                        $range,
                        $subject
                    );
    ...
    public function linkedGraphDistrictData()
    {
        ...
        foreach ($grades as $grade) {
            ...
            foreach ($state_temp_data as $state) {
                foreach ($subjects as $subject) {
                    $district_temp_data = DB::table(
                        'visualization_performance_graph_tbl'
                    )
                        ->where('grade', $grade)
                        ->where('state_id', $state->state_id)
                        ->where('district_id', '!=', 0)
                    ...
                    foreach ($avs as $legend => $av) {
                        foreach ($av as $value) {
                            $final_district_data[$subject]['avs'][
                                $final[$value]
                            ] = $this->generate_district_av_data(
                                $district_temp_data,
                                $legend,
                                $value,
                                $subject
                    ...
                    $final_district_data[$subject][
                        'lo'
                    ] = $this->generate_district_lo_data(
                        $district_temp_data,
                        $subject
                    );
                    foreach ($ranges as $range) {
                        $final_district_data[$subject]['range'][
                            $final[$range]
                        ] = $this->generate_district_range_data(
                            $district_temp_data,
                            $range,
                            $subject
                        );
    ...
    public function generate_state_av_data($data, $legend, $value, $subject)
    {
        ...
        foreach ($data as $state) {
            ...
            $state_name = DB::table('state_masters')
                ->where('udise_state_code', $state->state_id)
                ->first();
            // dd($temp_data->$legend->state);
            if ($legend == 'cards') {
                $formatted_data[$state_name->state_name] = round(
                    $temp_data->$legend->state
                );
            } else {
                $formatted_data[$state_name->state_name] =
                    $temp_data->$legend->state->$value;
            }
        }
    ...
    public function generate_district_av_data($data, $legend, $value, $subject)
    {
        ...
        foreach ($data as $district) {
            ...
            $temp_data = $temp_data->$subject;
            $district_name = DB::table('district_masters')
                ->where('udise_district_code', $district->district_id)
                ->first();
            // dd($temp_data->$legend->state);
            if ($legend == 'cards') {
                $formatted_data[$district_name->district_name] = round(
                    $temp_data->$legend->district
                );
            } else {
                $formatted_data[$district_name->district_name] =
                    $temp_data->$legend->district->$value;
            }
        }
        return $formatted_data;
    }
    ...
    public function generate_district_range_data($data, $range, $subject)
    {
        ...
        foreach ($data as $district) {
            ...
            $district_name = DB::table('district_masters')
                ...
                ->first();
            $formatted_data[$district_name->district_name] =
                $temp_data->performance_level->district->$range;
        }
        return $formatted_data;
    }
    public function generate_state_range_data($data, $range, $subject)
    {
        ...
        foreach ($data as $state) {
            ...
            $state_name = DB::table('state_masters')
                ...
                ->first();
            $formatted_data[$state_name->state_name] =
                $temp_data->performance_level->state->$range;
        }
        return $formatted_data;
    }
    ...
    public function generate_state_lo_data($data, $subject)
    {
        $formatted_data = [];
        $lo_codes = array_keys(
            (array) json_decode($data[0]->data)->$subject->lo->state
        );
        // dd($lo_codes);
        foreach ($lo_codes as $lo) {
            foreach ($data as $state) {
                ...
                $state_name = DB::table('state_masters')
                    ->where('udise_state_code', $state->state_id)
                    ->first();
                $formatted_data[$lo][$state_name->state_name] =
                    $temp_data->state->$lo;
            }
        }
        return $formatted_data;
    ...
    public function generate_district_lo_data($data, $subject)
    {
        $formatted_data = [];
        $lo_codes = array_keys(
            (array) json_decode($data[0]->data)->$subject->lo->district
        );
        // dd($lo_codes);
        foreach ($lo_codes as $lo) {
            foreach ($data as $district) {
                ...
                $district_name = DB::table('district_masters')
                    ->where('udise_district_code', $district->district_id)
                    ->first();
                $formatted_data[$lo][$district_name->district_name] =
                    $temp_data->district->$lo;
            }
        }
        return $formatted_data;
    }
