...
//  DRC Final Data District Wise Update District Master
    public function index(){
        ...
        District_Master::query()->update([
            ...
            'child_sex_ratio'=>0,
            'no_of_schools'=>0,
            'state_govt_schools'=>0,
            'govt_aided_schools'=>0,
            'central_govt_schools'=>0,
            'private_unaided_reco_schools'=>0,
            'teacher_state_govt_schools'=>0,
            'teacher_govt_aided_schools'=>0,
            'teacher_central_govt_schools'=>0,
            'teacher_private_unaided_reco_schools'=>0
