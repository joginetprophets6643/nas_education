...
class CommonController extends Controller
{
    public function view_parti_g3_school()
    {
        ...
        $at5GradeData = DB::table('dummy_at5s')
            ...
            WHEN p_qs.pq_gender= '1' THEN 'Boys' END)::decimal/count(dummy_at5s.id))*100) AS male_gender"),DB::raw("round((count(CASE WHEN p_qs.pq_gender= '2' THEN 'Girls' END)::decimal/count(dummy_at5s.id))*100) AS female_gender"),DB::raw("count(dummy_at5s.id)  AS total_student"),DB::raw("count(CASE WHEN dummy_at5s.at5_socgrp= '1' THEN 'SC' END) AS sc_social_group_count"),DB::raw("count(CASE WHEN dummy_at5s.at5_socgrp= '2' THEN 'OBC' END) AS obc_social_group_count"),DB::raw("count(CASE WHEN dummy_at5s.at5_socgrp= '3' THEN 'ST' END) AS st_social_group_count"),DB::raw("count(CASE WHEN dummy_at5s.at5_socgrp= '4' THEN 'GENERAL' END) AS general_social_group_count"),DB::raw("count(CASE WHEN pq_gender= '1' THEN 'Boys' END) AS male_gender_count"),DB::raw("count(CASE WHEN pq_gender= '2' THEN 'Girls' END) AS female_gender_count"),DB::raw("count(CASE WHEN nas_exam_details.sch_loc_r_u= '1' THEN 'Rural' END) AS rural_location_count"),DB::raw("count(CASE WHEN nas_exam_details.sch_loc_r_u= '2' THEN 'Urban' END) AS urban_location_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F1' THEN 'Govt School' END) AS govt_school_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F2' THEN 'Govt Aided' END) AS govt_aided_school_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F3' THEN 'Private' END) AS private_school_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F4' THEN 'Central govt' END) AS central_govt_school_count"))
        ...
        $at8GradeData = DB::table('dummy_at8')
            ...
            WHEN p_qs.pq_gender= '1' THEN 'Boys' END)::decimal/count(dummy_at8.id))*100) AS male_gender"),DB::raw("round((count(CASE WHEN p_qs.pq_gender= '2' THEN 'Girls' END)::decimal/count(dummy_at8.id))*100) AS female_gender"),DB::raw("count(dummy_at8.id)  AS total_student"),DB::raw("count(CASE WHEN dummy_at8.at8_socgrp= '1' THEN 'SC' END) AS sc_social_group_count"),DB::raw("count(CASE WHEN dummy_at8.at8_socgrp= '2' THEN 'OBC' END) AS obc_social_group_count"),DB::raw("count(CASE WHEN dummy_at8.at8_socgrp= '3' THEN 'ST' END) AS st_social_group_count"),DB::raw("count(CASE WHEN dummy_at8.at8_socgrp= '4' THEN 'GENERAL' END) AS general_social_group_count"),DB::raw("count(CASE WHEN pq_gender= '1' THEN 'Boys' END) AS male_gender_count"),DB::raw("count(CASE WHEN pq_gender= '2' THEN 'Girls' END) AS female_gender_count"),DB::raw("count(CASE WHEN nas_exam_details.sch_loc_r_u= '1' THEN 'Rural' END) AS rural_location_count"),DB::raw("count(CASE WHEN nas_exam_details.sch_loc_r_u= '2' THEN 'Urban' END) AS urban_location_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F1' THEN 'Govt School' END) AS govt_school_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F2' THEN 'Govt Aided' END) AS govt_aided_school_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F3' THEN 'Private' END) AS private_school_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F4' THEN 'Central govt' END) AS central_govt_school_count"))
        ...
        $at10GradeData = DB::table('dummy_at10s')
            ...
            WHEN p_qs.pq_gender= '1' THEN 'Boys' END)::decimal/count(dummy_at10s.id))*100) AS male_gender"),DB::raw("round((count(CASE WHEN p_qs.pq_gender= '2' THEN 'Girls' END)::decimal/count(dummy_at10s.id))*100) AS female_gender"),DB::raw("count(dummy_at10s.id)  AS total_student"),DB::raw("count(CASE WHEN dummy_at10s.at1_socgrp= '1' THEN 'SC' END) AS sc_social_group_count"),DB::raw("count(CASE WHEN dummy_at10s.at1_socgrp= '2' THEN 'OBC' END) AS obc_social_group_count"),DB::raw("count(CASE WHEN dummy_at10s.at1_socgrp= '3' THEN 'ST' END) AS st_social_group_count"),DB::raw("count(CASE WHEN dummy_at10s.at1_socgrp= '4' THEN 'GENERAL' END) AS general_social_group_count"),DB::raw("count(CASE WHEN pq_gender= '1' THEN 'Boys' END) AS male_gender_count"),DB::raw("count(CASE WHEN pq_gender= '2' THEN 'Girls' END) AS female_gender_count"),DB::raw("count(CASE WHEN nas_exam_details.sch_loc_r_u= '1' THEN 'Rural' END) AS rural_location_count"),DB::raw("count(CASE WHEN nas_exam_details.sch_loc_r_u= '2' THEN 'Urban' END) AS urban_location_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F1' THEN 'Govt School' END) AS govt_school_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F2' THEN 'Govt Aided' END) AS govt_aided_school_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F3' THEN 'Private' END) AS private_school_count"),DB::raw("count(CASE WHEN nas_exam_details.frame= 'F4' THEN 'Central govt' END) AS central_govt_school_count"))
