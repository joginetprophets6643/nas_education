...
const Tabs = () => {
  ...
  return (
    <ul className="nav nav-tabs" id="visualtab" role="tablist">
        ...
        <li className="nav-item" role="presentation">
            <button className="nav-link" id="class5-tab" data-bs-toggle="tab" data-bs-target="#class5" type="button" role="tab" aria-controls="class5" aria-selected="false" onClick={(e)=>{changeGrade(5)}}>class 5</button>
        </li>
        <li className="nav-item" role="presentation">
            <button className="nav-link" id="class8-tab" data-bs-toggle="tab" data-bs-target="#class8" type="button" role="tab" aria-controls="class8" aria-selected="false" onClick={(e)=>{changeGrade(8)}}>class 8</button>
        </li>
        <li className="nav-item" role="presentation">
            <button className="nav-link" id="class10-tab" data-bs-toggle="tab" data-bs-target="#class10" type="button" role="tab" aria-controls="class10" aria-selected="false" onClick={(e)=>{changeGrade(10)}}>class 10</button>
        </li>
        <li className="nav-item" role="presentation">
