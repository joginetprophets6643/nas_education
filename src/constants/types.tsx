...
export const CHART_FETCH_PENDING = "CHART_FETCH_PENDING";
export const CHART_FETCH_FULFILLED = "CHART_FETCH_FULFILLED";
export const CHART_FETCH_REJECTED = "CHART_FETCH_REJECTED";
export const CHART_FETCH_RESET = "CHART_FETCH_RESET";

export const LINKED_CHART_FETCH = "LINKED_CHART_FETCH";
export const LINKED_CHART_FETCH_PENDING = "LINKED_CHART_FETCH_PENDING";
export const LINKED_CHART_FETCH_FULFILLED = "LINKED_CHART_FETCH_FULFILLED";
export const LINKED_CHART_FETCH_REJECTED = "LINKED_CHART_FETCH_REJECTED";
export const LINKED_CHART_FETCH_RESET = "LINKED_CHART_FETCH_RESET";

export const SCATTER_LINKED_CHART_FETCH = "SCATTER_LINKED_CHART_FETCH";
export const SCATTER_LINKED_CHART_FETCH_PENDING = "SCATTER_LINKED_CHART_FETCH_PENDING";
export const SCATTER_LINKED_CHART_FETCH_FULFILLED = "SCATTER_LINKED_CHART_FETCH_FULFILLED";
export const SCATTER_LINKED_CHART_FETCH_REJECTED = "SCATTER_LINKED_CHART_FETCH_REJECTED";
export const SCATTER_LINKED_CHART_FETCH_RESET = "SCATTER_LINKED_CHART_FETCH_RESET";
